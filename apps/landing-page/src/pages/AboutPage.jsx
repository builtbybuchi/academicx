    ...
    return (
        <div style={{ background: '#FFFFFF', minHeight: '100vh', padding: '100px 40px' }}>
            <div style={{ maxWidth: 800, margin: '0 auto' }}>
                ...
                <p style={{ fontSize: 16, color: 'var(--color-gray-600)', marginBottom: 24, lineHeight: 1.8 }}>
                    From our custom PIN-based Result Access system to automated broadsheet generation and our internal & external communication system, we ensure every touchpoint is fast, secure, and delightful to use.
                </p>
            </div>
        </div>
    );
