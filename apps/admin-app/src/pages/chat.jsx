...
export default function AdminChat() {
    ...
    return (
        <div>
            <div className="page-header"><h1 className="page-title">Chat</h1><p className="page-subtitle">Real-time messaging with staff and administrators</p></div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 16, height: 'calc(100vh - 200px)' }}>
                <LiquidGlassPanel hover={false} style={{ padding: 0, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ padding: '12px 16px', borderTop: '1px solid rgba(255,255,255,0.06)', display: 'flex', gap: 8 }}>
                        <input className="input" placeholder="Type a message..." value={input} onChange={(event) => setInput(event.target.value)}
                            onKeyDown={(event) => event.key === 'Enter' && send()} style={{ flex: 1 }} />
