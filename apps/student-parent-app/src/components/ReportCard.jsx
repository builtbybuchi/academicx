...
const ReportCard = ({ data, subjectsById, school }) => {
        ...
        <div className="report-card-container" style={{
            ...
            <table className="results-table">
                ...
                <tbody>
                    {results.map((r, i) => (
                        <tr key={i}>
                            <td style={{ fontWeight: 500 }}>{subjectsById[r.subjectId] || r.subjectId}</td>
            ...
            <div className="comments-section">
                ...
                <div className="comment-box">
                    {student?.teacherComment || 'Excellent performance this term. Keep up the good work and focus on maintaining consistency in mathematics.'}
                </div>
            </div>
